...
import Products from '@/pages/entrepreneur/Products';
import Orders from '@/pages/entrepreneur/Orders';
import Customers from '@/pages/entrepreneur/Customers';
...
function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <ThemeProvider defaultTheme="system" storageKey="catatuy-theme">
        <AuthProvider>
          <LanguageProvider>
