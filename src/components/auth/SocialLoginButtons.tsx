...
const SocialLoginButtons = ({ onSocialLogin, loading = false }: SocialLoginButtonsProps) => {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <motion.button
          ...
          disabled={loading}
          className="flex justify-center items-center h-12 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
        >
