    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full relative">
        ...
        <div className={cn("flex-1 transition-all duration-300 flex justify-center", !isMobile && "ml-64")}> 
          <main 
            className={cn(
              "w-full max-w-screen-lg xl:max-w-[1200px] mx-auto px-4 md:px-6 py-6 md:py-8 h-full overflow-y-auto bg-gradient-to-b from-purple-50/30 to-white/80 dark:from-gray-900/20 dark:to-gray-800/10 text-base md:text-lg",
