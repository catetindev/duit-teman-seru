...
const EntrepreneurSection = () => {
  ...
  const entrepreneurFeatures = ["Jualan online", "Jadi reseller", "Punya usaha sampingan"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          once: true
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3">
                {entrepreneurFeatures.map((feature, i) => <motion.li key={i} initial={{
                opacity: 0,
                x: -10
              }} whileInView={{
                opacity: 1,
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={goToSignup} className="bg-purple-500 hover:bg-purple-600 text-white rounded-xl">
                Coba Sekarang
              </Button>
              <Button onClick={goToPricing} variant="outline" className="border-2 border-purple-200 hover:bg-purple-50 text-purple-700 rounded-xl">
                Lihat Harga
              </Button>
            </div>
          </motion.div>
          ...
          once: true
            ...
            <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 transform rotate-1 relative z-10">
              ...
              <img alt="Entrepreneur Mode Dashboard" className="w-full rounded-lg mb-4 shadow-sm object-cover" src="/lovable-uploads/fc467307-6639-41fc-a231-3299f30a4414.png" />
