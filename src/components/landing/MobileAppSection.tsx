          ...
          once: true
            ...
            <div className="relative">
              <div className="rounded-[3rem] p-2 w-full md:w-[500px] mx-auto">
                <img src="/lovable-uploads/b2e023e4-8b66-4848-89b7-af73cf396e8e.png" alt="Mobile app illustration" className="w-full h-auto rounded-3xl transition-all duration-300" />
              </div>
            </div>
          </motion.div>
        </div>
