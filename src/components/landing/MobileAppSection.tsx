        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <Button 
                onClick={goToSignup}
                className="bg-[#28e57d] hover:bg-[#28e57d]/90 text-white font-medium px-6 py-3 h-auto rounded-xl shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all duration-300 flex items-center gap-2 w-full sm:w-auto justify-center"
              >
                Daftar Sekarang
            ...
            <div className="relative">
              <div className="rounded-[3rem] p-2 w-full md:w-[500px] mx-auto">
                <img 
                  ...
                  className="w-full h-auto rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300" 
                />
              </div>
            </div>
          </motion.div>
