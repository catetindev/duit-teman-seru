        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                variant="outline" 
                size="lg" 
                className="border-[#28e57d] text-[#28e57d] hover:bg-[#28e57d]/5 hover:border-[#28e57d] rounded-xl px-6"
              >
          ...
          >
            <div className="relative">
              <div className="bg-gray-900 rounded-[3rem] p-8 w-[340px] mx-auto shadow-xl flex items-center justify-center">
                <img 
