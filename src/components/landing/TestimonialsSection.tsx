...
const TestimonialsSection = () => {
  return (
    <section className="bg-gradient-to-b from-white to-[#F8FAF9] dark:from-gray-900 dark:to-gray-800 py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="inline-flex items-center gap-1.5 bg-[#FFEBF0] text-pink-600 px-3.5 py-1.5 rounded-full text-sm font-medium mb-4">
              ...
              <Card className="h-full bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden">
                <CardContent className="p-6 md:p-8">
                  <div className="flex mb-4">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <StarIcon key={star} className="h-5 w-5 text-yellow-500 fill-yellow-500" />
                    ))}
                  </div>
