...
const HeroSection = () => {
  ...
  return <section className="container mx-auto md:py-24 mt-16 sm:mt-20 my-0 px-[16px] py-0">
      <div className="max-w-4xl mx-auto md:text-center">
        ...
        duration: 0.8
          ...
          <img src="/lovable-uploads/cdbfc368-edb8-448f-993c-3230adb08c71.png" alt="App Dashboard Preview" className="w-full h-auto rounded-2xl hover:scale-[1.01] transition-all duration-500" />
        </motion.div>
      </div>
    </section>;
};
